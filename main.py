...
class Game:
    ...
    def load_data(self):
        ...
        for img in MUZZLE_FLASHES:
            self.gun_flashes.append(pg.image.load(path.join(image_folder, img)).convert_alpha())
        self.item_images = {}
    ...
    def show_go_screen(self):
        ...
        self.draw_text("Press a key to start", self.title_font, 75, WHITE, WIDTH / 2, HEIGHT + 3 / 4 - 70, align="center")
        pg.display.flip()
        self.wait_for_key()
